      ...
      >
        ...
        {!sidebarCollapsed && (
          <div className="space-y-2 border-t border-white/10 p-4">
            ...
            <div className="text-xs text-[#2D4A3E]">Store Admin</div>
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-14 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-4 lg:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#2D4A3E] text-xs font-semibold text-white">
